...
export function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed left-0 top-0 z-50 flex h-full w-64 flex-col bg-white shadow-xl transition-transform duration-300 lg:static lg:translate-x-0",
      ...
      >
        ...
        <div className="flex h-16 items-center justify-between border-b px-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold text-gray-900">Social Studio</span>
          </div>
          <button
            onClick={onClose}
